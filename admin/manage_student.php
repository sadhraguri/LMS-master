...
//$mail->addAttachment('/tmp/image.jpg', 'new.jpg');    // Optional name
    ...
    $mail->Subject = 'Successfully Registration to Online Test Tool.';
    $mail->Body    = '<html><h1>Welcome to Online Test Tool.</h1><br/>
<br/><h4><li>UserID:'.$loginid.'</li></h4><h4><li>Password:'.$_POST['password'].'</li><h4>
<a href="http://localhost/LMS-master/confirmMe.php?hex='.$password.'">Click Here</a> to <h3>Activate</h3> your Account.
