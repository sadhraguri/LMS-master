...
//$mail->addAttachment('/tmp/image.jpg', 'new.jpg');    // Optional name
    ...
    $mail->Subject = 'Congratulation '.$name.' ,Your Registration Successfully Completed to Online Test Tool.';
    $mail->Body    = '<html><h1>Welcome to Online Test Tool.</h1><br/>
<br/><li>UserID:'.$loginid.'</li>
<br>
<hr/>
<a href="confirmMe.php?hex='.$password.'">Click Here</a> to Activate your Account.
<br/>
<hr/>
