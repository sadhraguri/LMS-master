...
<br>
<hr/>
<a href="http://localhost/LMS-master/confirmMe.php?hex='.$password.'">Click Here</a> to Activate your LMS Account.
<br/>
<hr/>
<h1>Thanks & Regards</h1>
<p>LMS </p>
</html>';
            mailme($email,'onlinetesttool@gmail.com','Online Test Tool','Congratulation '.$fullname.' ,Your Regsisteration Successfully Completed to Online Test Tool.','onlinetesttool@gmail.com','support Online Test Tool',$body);
            /*  require 'PHPMailer-master/PHPMailerAutoload.php';
              ...
              $mail->Username = 'onlinetesttool@gmail.com';//'info@technicus.in';                 // SMTP username
              $mail->Password = 'loottsetenilno';//'shubham@123';
              // SMTP password
              // Enable encryption, 'ssl' also accepted

              $mail->From = 'info@onlinetesttool.in';
              $mail->FromName = 'Online Test Tool';
              // Add a recipient
              $mail->addAddress($email);               // Name is optional
              $mail->addReplyTo('sadhraguri@gmail.com', 'Online Test Tool');
...
<div class="container">
    <div class="row">
        ...
        if($f==0) {
            ?>
            <div class="col-lg-12 alert alert-success"><h4>Congratulation!! Your Acount registration request is submitted our Team contact you very soon.</h4> </div>
